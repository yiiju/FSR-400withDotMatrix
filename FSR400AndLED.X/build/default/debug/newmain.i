...
int count;
# 19 "./DrawLight.h"
unsigned short brake[8] = { 0b11100111,
                            0b00100100,
                            0b00000000,
                            0b11011111,
                            0b11011111,
...
void main()
{
    ...
    while(1) {
        ...
        if(mode == 1) mode = (voltage > 0.3) ? 4 : 1;
        if(mode > 0) MAX7219_1Unit(max7219_REG_shutdown, 0x01);
        ...
        if(shine == 1) {
            ...
            if(mode == 1) {
                ...
                TurnOff();
                MAX7219_1Unit(max7219_REG_shutdown, 0x00);
            }
        }
    }
}
